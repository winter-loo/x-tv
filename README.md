...
| **X Article 全屏沉浸阅读** | **全屏视频播放与进度快进** |
| :---: | :---: |
| ![X Article 全屏沉浸阅读](docs/assets/fullscreen_reading.gif) | ![全屏视频播放与进度快进](docs/assets/video_playback.gif) |
| 针对 4000+ 字 X Article 深度长文优化，纯净无干扰大屏排版，遥控器平滑分段滚动翻阅 | 原生全屏视频播放，遥控器左右键 10s 精准快退/快进，高对比进度条与定位提示 |
| **遥控快捷点赞互动** | **作者专属个人主页** |
| ![遥控快捷点赞互动](docs/assets/click_like.gif) | ![作者专属个人主页](docs/assets/author_profile.gif) |
| 遥控菜单一键标记喜欢，卡片底部即时点亮粉红爱心徽标与互动状态更新 | 左右双栏大屏布局，清晰展示认证资料、统计数据、关注按钮与历史发布列表 |
...
| 视频 | 确认播放 / 暂停；左右快退 / 快进（10 秒）；上下调整倍速（0.5x ~ 2.0x）；菜单键切换画质（360p / 720p / 1080p）；返回退出播放 |
| 菜单键 / 右键菜单 | 喜欢、写评论、查看作者以及当前帖子的链接；关注入口位于作者简介页 |

作者页支持动态加载作者历史推文与向下分页，并保持本地推文零延迟呈现。X 的网页和接口变化可能影响登录、读取和操作。
